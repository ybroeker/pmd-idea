...
public class PsiElementsTest extends LightJavaCodeInsightTestCase {

    //Uses short parameter name to detect off-by-one errors
    public void testShouldReturnCorrectPisElement() throws Exception {
        String fileContent = new BufferedReader(new InputStreamReader(PsiElementsTest.class.getResourceAsStream("/TestClass.java"))).lines().collect(Collectors.joining("\n"));
        ...
        final PsiElement element = PsiElements.getElement(fileFromText, 6, 42);
